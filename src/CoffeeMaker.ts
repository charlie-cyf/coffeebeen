    ...
    public parseData(){
        ...
        function makeCover(companyName:string, address:string, HR:string, period:string){
            ...
            return "May 18, 2018\n\n"+ HR +"\n"+ companyName +"\n" + address + "\n\n" + "Dear " + sulute+":\n\n" + "\t\t\tRe: Application Software Developer Co-op Position\n\n"+
                ...
                "\n" +
                "I am very excited to learn more about this opportunity and further share how my technical skills will be a great fit at "+ companyName +". Thank you for taking the time to consider my application. I'm looking forward to hearing from you.\n" +
                "\n" +
                "Sincerely,\n" +
                "\n" +
                "Charlie Chen\n";
